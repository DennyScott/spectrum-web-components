...
function querySelectorAllSubtree(element, selectors) {
    ...
    queryIdRefs(element, 'aria-owns').forEach(function (root) {
        ...
        elements.push.apply(
            elements,
            arrayFrom(root.querySelectorAllWithShadowDOM(selectors))
        );
    });
    return elements;
}
...
function getLabels(element) {
    ...
    return arrayFrom(document.querySelectorAllWithShadowDOM('label')).filter(
        function (label) {
...
function computeTextAlternative(root) {
    ...
    function computeTextAlternative(current, context) {
        ...
        if (!skipToStep2E) {
            var ariaLabel = (
                (isElement$1(current) && current.getAttribute('aria-label')) ||
                ''
            ).trim();
        ...
        if (
            ...
            (isElement$1(current) && context.isReferenced) ||
    ...
    var iterate = (module.exports = function (
        ...
        if (IS_ITERATOR) {
            ...
            if (isArrayIteratorMethod(iterFn)) {
                for (
                    index = 0, length = toLength$1(iterable.length);
                    length > index;
                    index++
                ) {
                    result = AS_ENTRIES
...
var slice_1 = function (it) {
    ...
    return it === ArrayPrototype$1 ||
        (it instanceof Array && own === ArrayPrototype$1.slice)
        ? slice
        : own;
};
...
var ariaDpubRoles_1 = createCommonjsModule(function (module, exports) {
    ...
    var _docAcknowledgmentsRole = interopRequireDefault(
...
var rolesMap_1 = createCommonjsModule(function (module, exports) {
    ...
    function _createForOfIteratorHelper(o, allowArrayLike) {
        var it;
        if (
            typeof _symbol.default === 'undefined' ||
            (0, _getIteratorMethod2.default)(o) == null
        ) {
            if (
    ...
    function _unsupportedIterableToArray(o, minLen) {
        ...
        if (!o) return;
        if (typeof o === 'string') return _arrayLikeToArray(o, minLen);
        var n = (0, _slice.default)(
            (_context2 = Object.prototype.toString.call(o))
        ).call(_context2, 8, -1);
        if (n === 'Object' && o.constructor) n = o.constructor.name;
    ...
    (0, _forEach.default)(
        ...
        (0, _forEach.default)(roleSet).call(roleSet, function (
            roleDefinition,
            name
        ) {
    ...
    (0, _forEach.default)(rolesMap).call(rolesMap, function (
        roleDefinition,
        name
    ) {
...
function _unsupportedIterableToArray$1(o, minLen) {
    ...
    var n = slice$4((_context = Object.prototype.toString.call(o))).call(
        _context,
        8,
        -1
    );
...
var find_1 = function (it) {
    ...
    return it === ArrayPrototype$4 ||
        (it instanceof Array && own === ArrayPrototype$4.find)
        ? find
        : own;
};
...
var concat_1 = function (it) {
    ...
    return it === ArrayPrototype$5 ||
        (it instanceof Array && own === ArrayPrototype$5.concat)
        ? concat
        : own;
};
...
function _iterableToArray(iter) {
    if (typeof symbol$4 !== 'undefined' && isIterable$1(Object(iter)))
        return from_1$4(iter);
}
                    ...
                    if (concept) {
                        ...
                        var roles = ((0, _find.default)(
                            (_context4 = (0, _toConsumableArray2.default)(
                                (0, _entries.default)(elementRoleMap).call(
                                    elementRoleMap
                                )
                            ))
                ...
                if (relation.module === 'HTML') {
                    ...
                    if (concept) {
                        var relationConcepts =
                            roleElementMap.get(key) || new _set.default([]);
    ...
    var LZString = (function () {
        ...
        var LZString = {
            ...
            compressToUint8Array: function (uncompressed) {
                ...
                for (
                    var i = 0, TotalLen = compressed.length;
                    i < TotalLen;
                    i++
                ) {
            ...
            decompressFromUint8Array: function (compressed) {
                if (compressed === null || compressed === undefined) {
                    ...
                    for (var i = 0, TotalLen = buf.length; i < TotalLen; i++) {
                        buf[i] =
                            compressed[i * 2] * 256 + compressed[i * 2 + 1];
                    }
...
function getCodeFrame(frame) {
    ...
    var codeFrame = codeFrameColumns(
        rawFileContents,
        {
            start: {
                line: line,
...
function getUserCodeFrame() {
    ...
    var err = new Error();
    var firstClientCodeFrame = err.stack
        .split('\n')
...
function checkContainerType(container) {
    if (
        ...
        !(typeof container.querySelectorAllWithShadowDOM === 'function')
    ) {
        throw new TypeError(
...
var logDOM = function () {
    ...
    if (userCodeFrame) {
        console.log(
            prettyDOM.apply(void 0, arguments) + '\n\n' + userCodeFrame
        );
    } else {
...
function getRealLabels(element) {
    ...
    if (element.labels !== undefined)
        return (_element$labels = element.labels) != null
            ? _element$labels
            : [];
...
function getLabels$1(container, element, _temp) {
    ...
    var labelsId = element.getAttribute('aria-labelledby')
        ? element.getAttribute('aria-labelledby').split(' ')
        : [];
    return labelsId.length
        ? labelsId.map(function (labelId) {
              var labellingElement = container.querySelector(
                  '[id="' + labelId + '"]'
              );
        ...
        : Array.from(getRealLabels(element)).map(function (label) {
              ...
              var labelledFormControl = Array.from(
                  label.querySelectorAllWithShadowDOM(
                      'button, input, meter, output, progress, select, textarea'
                  )
              ).filter(function (formControlElement) {
...
function getDefaultNormalizer(_temp) {
    var _ref = _temp === void 0 ? {} : _temp,
        ...
        collapseWhitespace =
            _ref$collapseWhitespa === void 0 ? true : _ref$collapseWhitespa;
...
function getSuggestedQuery(element, variant, method) {
    ...
    var labelText = getLabels$1(document, element)
        .map(function (label) {
                            ...
                            switch ((_context.prev = _context.next)) {
                                case 0:
                                    ...
                                    checkCallback = function () {
                                        ...
                                        try {
                                            var result = runWithExpensiveErrorDiagnosticsDisabled(
                                                callback
                                            );
                                    ...
                                    finished = false;
                                    promiseStatus = 'idle';
                                    overallTimeoutTimer = setTimeoutFn(
                                        handleTimeout,
                                        timeout
                                    );
                                ...
                                case 18:
                                    ...
                                    (_getWindowFromNode = getWindowFromNode(
                                        container
                                    )),
                                        (MutationObserver =
                                            _getWindowFromNode.MutationObserver);
...
function queryAllByAttribute(attribute, container, text, _temp) {
    ...
    return Array.from(
        container.querySelectorAllWithShadowDOM('[' + attribute + ']')
...
function queryByAttribute(attribute, container, text) {
    ...
    var els = queryAllByAttribute.apply(
        void 0,
        [attribute, container, text].concat(args)
    );
...
var wrapSingleQueryWithSuggestion = function (query, queryAllByName, variant) {
    return function (container) {
        ...
        var _args$slice$$suggest = _args$slice$.suggest,
            suggest =
                _args$slice$$suggest === void 0
                    ? getConfig().throwSuggestions
                    : _args$slice$$suggest;
...
var wrapAllByQueryWithSuggestion = function (query, queryAllByName, variant) {
    return function (container) {
        ...
        var _args$slice2$$suggest = _args$slice2$.suggest,
            suggest =
                _args$slice2$$suggest === void 0
                    ? getConfig().throwSuggestions
                    : _args$slice2$$suggest;
...
function buildQueries(queryAllBy, getMultipleError, getMissingError) {
    ...
    var getByWithSuggestions = wrapSingleQueryWithSuggestion(
        getBy,
        queryAllBy.name,
        'get'
    );
...
function queryAllLabels(container) {
    return Array.from(container.querySelectorAllWithShadowDOM('label,input'))
        .map(function (node) {
            return {
                node: node,
...
function queryAllByLabelText(container, text, _temp2) {
    ...
    var matchingLabelledElements = Array.from(
        container.querySelectorAllWithShadowDOM('*')
    )
        .filter(function (element) {
            return (
    ...
    return Array.from(new Set(matchingLabelledElements)).filter(function (
        element
    ) {
...
var getAllByLabelText = function (container, text) {
    ...
    if (!els.length) {
        var labels = queryAllLabelsByText.apply(
            void 0,
            [container, text].concat(rest)
        );

        if (labels.length) {
            var tagNames = labels
                .map(function (label) {
                    return getTagNameOfElementAssociatedWithLabelViaFor(
                        container,
                        label
                    );
                })
...
var _buildQueries = buildQueries(
        queryAllByPlaceholderText,
        getMultipleError$1,
        getMissingError
    ),
...
function queryAllByText(container, text, _temp) {
    ...
    return []
        .concat(
            baseArray,
            Array.from(container.querySelectorAllWithShadowDOM(selector))
        )
        .filter(function (node) {
...
var _buildQueries$1 = buildQueries(
        queryAllByText,
        getMultipleError$2,
        getMissingError$1
    ),
...
function queryAllByDisplayValue(container, value, _temp) {
    ...
    return Array.from(
        container.querySelectorAllWithShadowDOM('input,textarea,select')
    ).filter(function (node) {
        if (node.tagName === 'SELECT') {
            var selectedOptions = Array.from(node.options).filter(function (
                option
            ) {
...
var _buildQueries$2 = buildQueries(
        queryAllByDisplayValue,
        getMultipleError$3,
        getMissingError$2
    ),
...
function queryAllByAltText(container, alt, _temp) {
    ...
    return Array.from(
        container.querySelectorAllWithShadowDOM('img,input,area')
    ).filter(function (node) {
...
var _buildQueries$3 = buildQueries(
        queryAllByAltText,
        getMultipleError$4,
        getMissingError$3
    ),
...
var isSvgTitle = function (node) {
    ...
    return (
        ...
        ((_node$parentElement = node.parentElement) == null
            ? void 0
            : _node$parentElement.tagName.toLowerCase()) === 'svg'
    );
};
...
function queryAllByTitle(container, text, _temp) {
    ...
    return Array.from(
        container.querySelectorAllWithShadowDOM('[title], svg > title')
    ).filter(function (node) {
        return (
...
var _buildQueries$4 = buildQueries(
        queryAllByTitle,
        getMultipleError$5,
        getMissingError$4
    ),
...
function queryAllByRole(container, role, _temp) {
    var _ref = _temp === void 0 ? {} : _temp,
        ...
        hidden =
            _ref$hidden === void 0 ? getConfig().defaultHidden : _ref$hidden,
        name = _ref.name,
        trim = _ref.trim,
        normalizer = _ref.normalizer,
        _ref$queryFallbacks = _ref.queryFallbacks,
        queryFallbacks =
            _ref$queryFallbacks === void 0 ? false : _ref$queryFallbacks,
    ...
    return Array.from(container.querySelectorAllWithShadowDOM('*'))
        .filter(function (node) {
...
var getMissingError$5 = function (container, role, _temp3) {
    var _ref3 = _temp3 === void 0 ? {} : _temp3,
        ...
        hidden =
            _ref3$hidden === void 0 ? getConfig().defaultHidden : _ref3$hidden,
        name = _ref3.name;
...
var _buildQueries$5 = buildQueries(
        queryAllByRole,
        getMultipleError$6,
        getMissingError$5
    ),
...
function queryAllByTestId() {
    ...
    checkContainerType.apply(void 0, args);
    return queryAllByAttribute.apply(
        void 0,
        [getTestIdAttribute()].concat(args)
    );
}
...
function _waitForElement() {
    _waitForElement = _asyncToGenerator(
        /*#__PURE__*/ regenerator.mark(function _callee(callback, options) {
            return regenerator.wrap(function (_context) {
                while (1) {
                    switch ((_context.prev = _context.next)) {
                        case 0:
...
function _waitForElementToBeRemoved() {
    _waitForElementToBeRemoved = _asyncToGenerator(
        /*#__PURE__*/ regenerator.mark(function _callee(callback, options) {
                        ...
                        case 0:
                            ...
                            if (typeof callback !== 'function') {
                                ...
                                elements = Array.isArray(callback)
                                    ? callback
                                    : [callback];
                                getRemainingElements = elements.map(function (
                                    element
                                ) {
...
function createEvent(eventName, node, init, _temp) {
    ...
    var value = _eventInit$target.value,
        ...
        targetProperties = _objectWithoutPropertiesLoose(_eventInit$target, [
            'value',
            'files',
        ]);
    ...
    if (typeof EventConstructor === 'function') {
        ...
        var bubbles = eventInit.bubbles,
            ...
            otherInit = _objectWithoutPropertiesLoose(eventInit, [
                'bubbles',
                'cancelable',
                'detail',
            ]);
