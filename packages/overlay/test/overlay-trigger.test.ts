...
describe('Overlay Trigger', () => {
    ...
    it('dispatches events on open/close', async () => {
        ...
        // el.addEventListener('sp-opened', (event) => {
        //     opened = true
        //     openedEvent = event as CustomEvent<OverlayOpenCloseDetail>
        // })

        // el.addEventListener('sp-closed', (event) => {
        //     closed = true
        //     closedEvent = event as CustomEvent<OverlayOpenCloseDetail>
        // })
        ...
        expect(openedEvent.detail.content).to.equal(outerPopover);
        ...
        expect(closedEvent.detail.content).to.equal(outerPopover);
